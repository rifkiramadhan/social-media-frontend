...
const UpdatePost = () => {
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      image: '',
      category: postDetails?.postFound?.category?._id || '',
    },
    ...
    onSubmit: values => {
      ...
      updatePostMutation.mutate({ formData, postId });
    },
  });
  ...
  //isErr
  const isError = updatePostMutation.isError;
  //success
  const isSuccess = updatePostMutation.isSuccess;
  //Error
  const errorMsg = updatePostMutation?.error?.response?.data?.message;
  return (
