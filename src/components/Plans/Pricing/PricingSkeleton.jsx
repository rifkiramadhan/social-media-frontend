  ...
  return (
    <section className='py-24 bg-gray-100 animate-pulse'>
      <div className='mx-auto px-4 sm:px-8 lg:px-8'>
        ...
        <div className='h-4 bg-gray-300 rounded max-w-lg mx-auto mb-10'></div>
        ...
        <div className='flex flex-wrap mb-24 -mx-4'>
          ...
          <div className='w-full lg:w-1/2 p-4'>
            <div className='bg-white border border-gray-200 rounded-3xl px-8 lg:px-10 pb-14 pt-10 h-full'>
              ...
              <div className='h-14 bg-gray-300 rounded mb-10'></div>
          ...
          <div className='w-full lg:w-1/2 p-4'>
            <div className='bg-orange-300 rounded-3xl px-8 lg:px-10 pb-14 pt-10 h-full'>
        ...
        <div className='h-10 bg-gray-300 rounded w-1/2 mx-auto mb-20'></div>
